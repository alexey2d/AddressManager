...
public enum Countries {
    GERMANY("Germany", "DE", "DE", "276", "49"),
    RUSSIAN_FEDERATION("Russian Federation", "RU", "RUS", "643", "7"),
    UKRAINE("Ukraine", "UA", "UKR", "804", "380"),
    UNITED_KINGDOM("United Kingdome", "GB", "GBR", "826", "44"),
    UNITED_STATES("Unites States", "US", "USA", "840", "1");
...
//        ZIMBABWE("Zimbabwe", "ZW", "ZWE", "716");
    ...
    Countries(String countryName, String A2Code, String A3Code, String NMCode, String ISDCode) {
    ...
    /**
     * <p>Returns the telephone dialing prefixes.</p>
     *
     * @return {@link String}
     */
