...
//        sessionFactory.setMappingResources(new String[] {"ua.levelup"});
        sessionFactory.setPackagesToScan(new String[] {"ua.levelup.AddressManager.model"});
...
//        dataSource.setPassword(jdbcPass);
        dataSource.setUrl("jdbc:mysql://localhost:3306/AddressManager");
        dataSource.setUsername("root");
        dataSource.setPassword("");
//        dataSource.setPassword("S+ar+10g!n_db");
